...
def parse_args():
    ...
    parser.add_argument('--n-minibatch', type=int, default=5,
    ...
    parser.add_argument('--vf-coef', type=float, default=1, # 0.5
...
if __name__ == "__main__":
    ...
    print(args.num_selfplay_envs)
    print(args.num_bot_envs)
